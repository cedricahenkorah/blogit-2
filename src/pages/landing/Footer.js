      ...
      <div className="mx-auto max-w-screen-xl">
          ...
          <div className="grid ">
            <div>
              ...
              <ul className="text-gray-400">
                <li>
                  <p className="hover:underline">blogit@mail.com</p>
                </li>
                <li className="mt-4">
                  <p className="hover:underline">+233 000 222 3344</p>
                </li>
              </ul>
            </div>
            ...
            <div className="lg:mt-10 mt-5">
              ...
              <ul className="text-gray-400 grid grid-cols-2">
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          ...
          <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
            <a href="dss" className="text-gray-500 dark:hover:text-white">
              <svg
                className="w-5 h-5"
                fill="currentColor"
                viewBox="0 0 24 24"
